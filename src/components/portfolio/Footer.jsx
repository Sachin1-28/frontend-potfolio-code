...
import { Mail, Phone, MapPin, Linkedin, Github, Twitter, Instagram, ChevronUp, Heart } from "lucide-react";
            ...
            <div className="grid grid-cols-2 gap-3">
              {about?.socialLinks && Object.entries(about.socialLinks).map(([platform, url], index) => {
                ...
                return Icon ? (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-r ${colors[platform]} rounded-xl blur-lg opacity-0 group-hover:opacity-50 transition-all duration-500`}></div>
